...
include '../../Controller/enlistedDs_class.php';
$class = new enlistedDsClass;

$data = $class->enlistedDetails($tabla, $start, $Tpages, $bus_1, $bus_2, $bus_3, $campo_1, $campo_2, $campo_3, "'Despacho'"); ?>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="mb-4">
                        <div class="row mt-4 pt-4">
                            <div class="col-sm-2">
                                <h1 class="">Alistados</h1>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Alistados</li>
                                </ol>
                            </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <?php if (count($data) >= 1) { ?>
                                    <!-- Excel -->
                                    <div class="col-sm-1">
                                        <a class="btn btn-outline-success bi bi-file-earmark-excel" style="width:100%;" href="./excel.php?tb=<?php echo encrypt_decrypt('encrypt', 'enlistedDs') . '&id=' ?>">
                                        </a>
                                    </div>
                                <?php } ?>
                                <div class="col-sm-11">
                                    ...
                                    if ($data) {
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['alistado_fechaDespacho'] ?></td>
                                                <td class="table-responsive">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (!empty($row["kit"])) {
                                                                foreach (explode("__", $row["kit"]) as $kitConcatenados) {
                                                                    $kit = explode("..", $kitConcatenados);
                                                                    $pesoT = $pesoT + ($kit[2] * $kit[3]);
                                                                    $cantidadT = $cantidadT + $kit[3]; ?>
                                                ...
                                                <td><?php echo $row['alistado_clienteF'] ?></td>
                                                <td>
                                                    <br>
                                                ...
                                                <td>
                                                    <div class="row justify-content-center align-items-center mb-1">
                                                        <div class="col">
                                                            <a href="./excel.php?tb=<?php echo encrypt_decrypt('encrypt', 'enlistedDs') . '&id=' . $row['idAlistado'] ?>" class="btn btn-success bi bi-file-earmark-excel"></a>
                                                            <?php if ($_SESSION['usuario_Rol'] != 4) { ?>

                                                                <a href="./dispatch-new.php?id=<?php echo encrypt_decrypt('encrypt', $row['idAlistado']); ?>">
                                                                    <i class="bi bi-send btn" style="background-color: #FF6D00;color:#fff;"></i></a>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    <?php if ($_SESSION['usuario_Rol'] != 4) { ?>
                                                        ...
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="col">
                                                                <a href="./enlistedDs-new.php?upS=<?php echo encrypt_decrypt('encrypt', "up"); ?>&idUp=<?php echo encrypt_decrypt('encrypt', $row['idAlistado']); ?>&idCli= <?php echo $row['alistado_idCliente']; ?>"><i class="bi bi-pencil-square btn btn-primary"></i></a>

                                                                <?php if ($_SESSION['usuario_Rol'] == 1 or $_SESSION['usuario_Rol'] == 2) { ?>

                                                                    <i href="../../Ajax/ajax_enlistedDs.php?del=deleteEnlisted&id=<?php echo encrypt_decrypt('encrypt', $row['idAlistado']); ?>" class="bi bi-trash3 btn btn-danger btn_table_del"></i>
        ...
        function GetUserDetails(id, tabla) {
            ...
            $.post("../../Controller/modal_script.php", {
                ...
                function(data, status) {
                    ...
                    $("#alistadoDs_consecutivo_see").val(user.alistado_consecutivo);
                    $("#alistadoDs_cliente_see").val("CL-" + user.alistado_idCliente + "  " + user.cliente_nombre);
                    $("#alistadoDs_fecha_see").val(user.alistado_fechaDespacho);
                    $("#alistadoDs_nombrePersona_see").val(user.alistado_nombrePersona);
                    $("#alistadoDs_cedulaPersona_see").val(user.alistado_cedulaPersona);
                    $("#alistadoDs_placaPersona_see").val(user.alistado_placaPersona);
                    $("#alistadoDs_clienteF_see").val(user.alistado_clienteF);
                    $("#alistadoDs_codigo_see").val(user.alistado_codigo);
                    $("#alistadoDs_observacion_see").val(user.alistado_observacion);

                }
            );
            // Abrir modal
            $("#alistadoDs_modal").modal("show");
        }
